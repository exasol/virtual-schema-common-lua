...
local function rendering_error_contains(_, arguments)
    ...
    arguments.n = 3
    return string.find(result, expected_fragment, 1, true)
end
...
say:set("assertion.rendering_error.positive", "Rendered query\n%sExpected error containing:\n%sbut got: %s")
say:set("assertion.rendering_error.negative",
...
assert:register("assertion", "rendering_error_contains", rendering_error_contains, "assertion.rendering_error.positive",
        "assertion.rendering_error.negative")
